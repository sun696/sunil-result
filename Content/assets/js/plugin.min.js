! function(e, t) {
    ...
    var Q = Math.min,
        ...
        he = me.slice(3),
        ce_FLIP = "flip",
        ce_CLOCKWISE = "clockwise",
        ce_COUNTERCLOCKWISE = "counterclockwise",
        ge = function() {
            function t(o, n) {
                var i = this,
        ...
        typeCheckConfig: function(t, e, n) {
            for (var i in n)
                if (Object.prototype.hasOwnProperty.call(n, i)) {
                    var o = n[i],
                        s = e[i],
                        r = s && c.isElement(s) ? "element" : null === (a = s) || void 0 === a ? "" + a : {}.toString.call(a).match(/\s([a-z]+)/i)[1].toLowerCase();
...
function(i) {
    ...
    (e = function() {
        ...
        var o, s, n, r = this,
            l = i(e.currentTarget);
        switch (l.is("a") && e.preventDefault(), l.is("li") || (l = l.closest("li")), o = (n = r.slideCount % r.options.slidesToScroll != 0) ? 0 : (r.slideCount - r.currentSlide) % r.options.slidesToScroll, e.data.message) {
            case "previous":
...
function(t, e) {
    ...
    function s(e) {
        if (n(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
            ...
            var S = t(s.height);
            return !1 !== S && (a.height = S + (I ? 0 : y + z)), a.innerWidth = a.width - (p + _), a.innerHeight = a.height - (y + z), a.outerWidth = a.width + g, a.outerHeight = a.height + v, a
        }
    }
    ...
    d.ontransitionend = function(t) {
        if (t.target === this.element) {
            var e = this._transn,
                ...
                n;
            if (delete e.ingProperties[o], i(e.ingProperties) && this.disableTransition(), o in e.clean && (this.element.style[t.propertyName] = "", delete e.clean[o]), o in e.onEnd) e.onEnd[o].call(this), delete e.onEnd[o];
...
function(t, e) {
    ...
    return o._resetLayout = function() {
        ...
        var e = t.size.outerWidth % this.columnWidth,
            i, o = Math[e && e < 1 ? "round" : "ceil"](t.size.outerWidth / this.columnWidth);
        o = Math.min(o, this.cols);
        for (var n, s = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](o, t), r = {
        ...
        var i = e(t),
            ...
            n, s = this._getOption("originLeft") ? o.left : o.right,
            r = s + i.outerWidth,
            a = Math.floor(s / this.columnWidth);
        a = Math.max(0, a);
        var u = Math.floor(r / this.columnWidth);
        u -= r % this.columnWidth ? 0 : 1, u = Math.min(this.cols - 1, u);
        for (var h, d = (this._getOption("originTop") ? o.top : o.bottom) + i.outerHeight, l = a; l <= u; l++) this.colYs[l] = Math.max(d, this.colYs[l])
...
function() {
    ...
    b = function() {
        ...
        return a.prototype.get = function(a) {
            var b, c, d, e, f;
            for (b = d = 0, e = (f = this.keys).length; e > d; b = ++d)
                if ((c = f[b]) === a) return this.values[b]
        }, a.prototype.set = function(a, b) {
            var c, d, e, f, g;
            for (c = e = 0, f = (g = this.keys).length; f > e; c = ++e)
                if ((d = g[c]) === a) return void(this.values[c] = b);
        ...
        return e.prototype.defaults = {
            ...
            if (this.stopped = !1, this.boxes = function() {
                    var a, c, d, e;
                    for (e = [], a = 0, c = (d = this.element.querySelectorAll("." + this.config.boxClass)).length; c > a; a++) b = d[a], e.push(b);
                    return e
                }.call(this), this.all = function() {
                    var a, c, d, e;
                    for (e = [], a = 0, c = (d = this.boxes).length; c > a; a++) b = d[a], e.push(b);
                    return e
                }.call(this), this.boxes.length)
                if (this.disabled()) this.resetStyle();
                else
                    for (c = 0, d = (e = this.boxes).length; d > c; c++) b = e[c], this.applyStyle(b, !0);
            return this.disabled() || (this.util().addEvent(this.config.scrollContainer || window, "scroll", this.scrollHandler), this.util().addEvent(window, "resize", this.scrollHandler), this.interval = setInterval(this.scrollCallback, 50)), this.config.live ? new a(function(a) {
                return function(b) {
                    var c, d, e, f, g;
                    for (g = [], c = 0, d = b.length; d > c; c++) f = b[c], g.push(function() {
                        var a, b, c, d;
                        for (d = [], a = 0, b = (c = f.addedNodes || []).length; b > a; a++) e = c[a], d.push(this.doSync(e));
                        return d
                    }.call(a));
                    return g
                }
            ...
            if (null == a && (a = this.element), 1 === a.nodeType) {
                for (f = [], c = 0, d = (e = (a = a.parentNode || a).querySelectorAll("." + this.config.boxClass)).length; d > c; c++) b = e[c], g.call(this.all, b) < 0 ? (this.boxes.push(b), this.all.push(b), this.stopped || this.disabled() ? this.resetStyle() : this.applyStyle(b, !0), f.push(this.scrolled = !0)) : f.push(void 0);
                return f
            }
            ...
            var a, b, c, d, e;
            for (e = [], b = 0, c = (d = this.boxes).length; c > b; b++) a = d[b], e.push(a.style.visibility = "visible");
            return e
        }, e.prototype.resetAnimation = function(a) {
            var b;
            return a.type.toLowerCase().indexOf("animationend") >= 0 ? (b = a.target || a.srcElement).className = b.className.replace(this.config.animateClass, "").trim() : void 0
            ...
            for (c in d = [], b) e = b[c], a["" + c] = e, d.push(function() {
                var b, d, g, h;
                for (h = [], b = 0, d = (g = this.vendors).length; d > b; b++) f = g[b], h.push(a["" + f + c.charAt(0).toUpperCase() + c.substr(1)] = e);
                return h
            }.call(this));
            return d
        }, e.prototype.vendorCSS = function(a, b) {
            var c, e, f, g, h, i;
            for (g = (h = d(a)).getPropertyCSSValue(b), c = 0, e = (f = this.vendors).length; e > c; c++) i = f[c], g = g || h.getPropertyCSSValue("-" + i + "-" + b);
            return g
            ...
            return !this.scrolled || (this.scrolled = !1, this.boxes = function() {
                var b, c, d, e;
                for (e = [], b = 0, c = (d = this.boxes).length; c > b; b++)(a = d[b]) && (this.isVisible(a) ? this.show(a) : e.push(a));
                return e
            ...
            var b, c, d, e, f;
            return c = a.getAttribute("data-wow-offset") || this.config.offset, e = (f = this.config.scrollContainer && this.config.scrollContainer.scrollTop || window.pageYOffset) + Math.min(this.element.clientHeight, this.util().innerHeight()) - c, b = (d = this.offsetTop(a)) + a.clientHeight, e >= d && b >= f
